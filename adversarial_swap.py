...
from utils import lab_attack_faceswap, lab_attack_faceswap2  # 적대적 공격 함수 불러오기
...
if __name__ == '__main__':
    ...
    img_a_adv, _ = lab_attack_faceswap(img_id, img_att, model, epsilon=0.1, iter=100, output_dir = opt.output_path)
    ...
    output_path=opt.output_path+'result_combined_4_e0.03_.jpg'
            # Save images
